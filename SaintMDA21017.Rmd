...
I basically answered the other two questions already above ("are cancer (1) radii and concavity (2) different between malignant and benign cancer samples (it seems like yes, for both). As explained in 1.2 of this assignment:
 'I could formally test this, but I am more interested in whether I can use these metrics to predict sample diagnosis (Q3).' - this seems like a more interesting model (because the outcome is binary == M or B) - and, if these analyses were not strictly for pedagodical purposes, a more useful (as in clinicaly) question 
 
And I also want to examine Q4 becuase, based on fig x and fig z, we may have a relationship between radius and concavity that exists only in one level of sample diagnoses, which is of interest to me; As explained in 1.2 of this assignment: 
